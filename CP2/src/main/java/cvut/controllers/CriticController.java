...
public class CriticController {
    ...
    @PostMapping(value = "/createNewCritique", consumes = {MediaType.APPLICATION_JSON_VALUE, "multipart/form-data"})
    @PreAuthorize("hasAnyRole('ROLE_CRITIC')")
    ...
    @PutMapping(value = "/{critiqueId}/updateMyCritique", consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = "/{critiqueId}/deleteMyCritique")
    @PreAuthorize("(hasRole('ROLE_CRITIC') and @critiqueServiceImpl.checkOwner(#critiqueId, principal.username)) or hasRole('ROLE_ADMIN')")
